...
export declare namespace TerminalPayment {
    /** Transaction type. sale: original charge. refund: money returned. void: pre-settlement cancellation. */
    const Type: {
        readonly Sale: "sale";
    ...
    const Status: {
        ...
        readonly StandaloneApproved: "standalone_approved";
        readonly StandaloneDeclined: "standalone_declined";
    };
    type Status = (typeof Status)[keyof typeof Status];
}
//# sourceMappingURL=TerminalPayment.d.ts.map