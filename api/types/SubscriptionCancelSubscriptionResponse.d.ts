 ...
 */
export interface SubscriptionCancelSubscriptionResponse {
    data: SubscriptionCancelSubscriptionResponse.Data;
}
export declare namespace SubscriptionCancelSubscriptionResponse {
    interface Data {
        id: string;
        merchantId: string;
        customerId: string;
...
//# sourceMappingURL=SubscriptionCancelSubscriptionResponse.d.ts.map