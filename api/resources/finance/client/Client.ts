...
export class FinanceClient {
     ...
     */
    public getincome(
        request: RevKeen.FinanceGetIncomeRequest,
        requestOptions?: FinanceClient.RequestOptions,
    ): core.HttpResponsePromise<RevKeen.FinanceGetIncomeResponse> {
        return core.HttpResponsePromise.fromPromise(this.__getincome(request, requestOptions));
    }

    private async __getincome(
        request: RevKeen.FinanceGetIncomeRequest,
        requestOptions?: FinanceClient.RequestOptions,
    ): Promise<core.WithRawResponse<RevKeen.FinanceGetIncomeResponse>> {
        const {
        ...
        if (_response.ok) {
            return { data: _response.body as RevKeen.FinanceGetIncomeResponse, rawResponse: _response.rawResponse };
        }
    ...
    public getsummary(
        requestOptions?: FinanceClient.RequestOptions,
    ): core.HttpResponsePromise<RevKeen.FinanceGetSummaryResponse> {
        return core.HttpResponsePromise.fromPromise(this.__getsummary(requestOptions));
    }

    private async __getsummary(
        requestOptions?: FinanceClient.RequestOptions,
    ): Promise<core.WithRawResponse<RevKeen.FinanceGetSummaryResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return { data: _response.body as RevKeen.FinanceGetSummaryResponse, rawResponse: _response.rawResponse };
        }
