...
export declare class CreditNotesClient {
     ...
     *     })
     */
    invoiceEligibility(request: RevKeen.CreditNotesInvoiceEligibilityRequest, requestOptions?: CreditNotesClient.RequestOptions): core.HttpResponsePromise<RevKeen.CreditNotesInvoiceEligibilityResponse>;
    private __invoiceEligibility;
    /**
     ...
     *     })
     */
    transactionReversalEligibility(request: RevKeen.CreditNotesTransactionReversalEligibilityRequest, requestOptions?: CreditNotesClient.RequestOptions): core.HttpResponsePromise<RevKeen.CreditNotesTransactionReversalEligibilityResponse>;
    private __transactionReversalEligibility;
}
