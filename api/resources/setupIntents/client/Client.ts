...
export class SetupIntentsClient {
     ...
     */
    public list(
        request: RevKeen.ListSetupIntentsRequest = {},
        requestOptions?: SetupIntentsClient.RequestOptions,
    ): core.HttpResponsePromise<RevKeen.SetupIntentList> {
    ...
    private async __list(
        request: RevKeen.ListSetupIntentsRequest = {},
        requestOptions?: SetupIntentsClient.RequestOptions,
    ): Promise<core.WithRawResponse<RevKeen.SetupIntentList>> {
        const {
        ...
        if (_response.ok) {
            return { data: _response.body as RevKeen.SetupIntentList, rawResponse: _response.rawResponse };
        }
     ...
     */
    public create(
        request: RevKeen.CreateSetupIntentRequest = {},
        requestOptions?: SetupIntentsClient.RequestOptions,
    ): core.HttpResponsePromise<RevKeen.SetupIntent> {
    ...
    private async __create(
        request: RevKeen.CreateSetupIntentRequest = {},
        requestOptions?: SetupIntentsClient.RequestOptions,
    ): Promise<core.WithRawResponse<RevKeen.SetupIntent>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return { data: _response.body as RevKeen.SetupIntent, rawResponse: _response.rawResponse };
        }
     ...
     */
    public retrieve(
        request: RevKeen.RetrieveSetupIntentsRequest,
        requestOptions?: SetupIntentsClient.RequestOptions,
    ): core.HttpResponsePromise<RevKeen.SetupIntent> {
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.RevKeenEnvironment.Default,
                `setup-intents/${core.url.encodePathParam(id)}`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
     ...
     */
    public update(
        request: RevKeen.UpdateSetupIntentRequest,
        requestOptions?: SetupIntentsClient.RequestOptions,
    ): core.HttpResponsePromise<RevKeen.SetupIntent> {
     ...
     */
    public confirm(
        request: RevKeen.ConfirmSetupIntentRequest,
        requestOptions?: SetupIntentsClient.RequestOptions,
    ): core.HttpResponsePromise<RevKeen.SetupIntent> {
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.RevKeenEnvironment.Default,
                `setup-intents/${core.url.encodePathParam(id)}/confirm`,
            ),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
     ...
     */
    public cancel(
        request: RevKeen.CancelSetupIntentRequest,
        requestOptions?: SetupIntentsClient.RequestOptions,
    ): core.HttpResponsePromise<RevKeen.SetupIntent> {
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.RevKeenEnvironment.Default,
                `setup-intents/${core.url.encodePathParam(id)}/cancel`,
            ),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
