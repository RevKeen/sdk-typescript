...
export class PaymentsClient {
     ...
     *     })
     */
    public captureAPayment(
        request: RevKeen.CapturePaymentRequest,
        requestOptions?: PaymentsClient.RequestOptions,
    ): core.HttpResponsePromise<RevKeen.Payment> {
        return core.HttpResponsePromise.fromPromise(this.__captureAPayment(request, requestOptions));
    }

    private async __captureAPayment(
        request: RevKeen.CapturePaymentRequest,
        requestOptions?: PaymentsClient.RequestOptions,
    ): Promise<core.WithRawResponse<RevKeen.Payment>> {
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.RevKeenEnvironment.Default,
                `payments/${core.url.encodePathParam(id)}/cancel`,
            ),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
