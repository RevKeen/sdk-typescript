export interface CreatePaymentLinkResponse {
    ...
    name?: string;
    slug?: string | null;
    mode: CreatePaymentLinkResponse.Mode;
    status: CreatePaymentLinkResponse.Status;
    amount_minor?: number | null;
    currency?: string;
    invoice_id?: string | null;
    subscription_id?: string | null;
    product_ids?: string[];
    line_items?: CreatePaymentLinkResponse.LineItems.Item[];
    ...
    tax_behavior?: CreatePaymentLinkResponse.TaxBehavior;
...
//# sourceMappingURL=CreatePaymentLinkResponse.d.ts.map