...
/**
 * Parameters for scheduling a one-off Direct Debit collection against an active mandate. BACS is not real-time: the collection settles 3–5 working days after submission and nothing is marked paid until the bureau confirms.
 */
...
type CustomerPortalMandatesReauthorizeData = {
    ...
    path: {
        /**
         * ID of the mandate being replaced.
         */
        id: string;
    };
    query?: never;
...
type CustomerPortalMandatesReauthorizeResponses = {
    /**
     * New mandate created; the previous mandate superseded.
     */
